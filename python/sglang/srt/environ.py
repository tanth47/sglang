...
class Envs:
    ...
    SGLANG_DSPARK_VERIFY_TRACE_PATH = EnvStr("")
    SGLANG_DSPARK_VERIFY_TRACE_LIMIT = EnvInt(1000)
    SGLANG_DSPARK_VERIFY_TRACE_ASSERT = EnvBool(False)
    SGLANG_DSPARK_VERIFY_TRACE_ALL_RANKS = EnvBool(False)
    SGLANG_DSPARK_ACCEPT_SAMPLING_TRACE_ASSERT = EnvBool(False)
    SGLANG_DSPARK_ALLOW_DSA_COMPACT_BATCH = EnvBool(False)
    SGLANG_DSPARK_ALLOW_HIP_DSA_TARGET_VERIFY_GRAPH = EnvBool(False)
    SGLANG_DSPARK_LOG_SPS_PRED_INTERVAL = EnvInt(0)
    SGLANG_DSPARK_STS_COLLECT_PATH = EnvStr("")
    SGLANG_DSPARK_STS_FLUSH_EVERY = EnvInt(256)
    SGLANG_DSPARK_BLOCK_ACCEPT_ESTIMATE_MODE = EnvStr("")
